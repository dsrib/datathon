...
# Configuração do intervalo de anos lado a lado
    ...
    with col1[0]:
        ...
        fig2 = visualizations.scatter_plot(filtered_df, indicador_x, indicador_y, legenda, width=1000, height=500)
        ...
        st.components.v1.iframe(power_bi_report_url, width=1000, height=800, scrolling=True)
